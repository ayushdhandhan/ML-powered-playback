      ...
      >
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-orange-50 to-orange-100/50 flex flex-col items-center justify-center p-8 md:p-12 relative overflow-hidden">
           ...
           <img 
             src="/music_icon.png" 
             alt="Music Note" 
             className="w-48 h-48 absolute -top-10 -right-10 opacity-30 mix-blend-multiply rotate-12 blur-[2px]" 
           />
           <img 
             src="/music_icon.png" 
             alt="Music Note" 
             className="w-32 h-32 absolute -bottom-8 -left-8 opacity-20 mix-blend-multiply -rotate-12 blur-[1px]" 
           />
           
           <h3 className="text-2xl font-bold text-orange-600 mb-6 relative z-10 text-center">Your Adaptive Sound</h3>
           
           <img 
             src="/retro.png" 
             alt="Retro Boombox" 
             className="w-full max-w-[280px] object-cover rounded-3xl shadow-2xl relative z-10 hover:scale-105 transition-transform duration-500" 
           />
        </div>
