...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center bg-[#f5f5dc] pb-[72px] md:pb-0 overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-extrabold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-teal-700 to-green-700 tracking-tight">Create Account</h2>
        ...
        <p className="mt-8 text-center text-slate-600 text-sm font-medium">
          Already have an account? <Link to="/login" className="text-[#ea580c] hover:text-[#c2410c] font-bold transition-colors">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
